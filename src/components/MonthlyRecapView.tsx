    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-3.5 sm:p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 w-full md:w-auto">
          ...
          {/* Button: Masukan Perencanaan Bulanan */}
          {onOpenMonthlyPlan && (
            <button
        ...
        <div className="p-3.5 sm:p-5 border-b border-slate-100 flex flex-col gap-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                onClick={onAddNew}
                className="inline-flex items-center space-x-1.5 px-2.5 sm:px-3 py-1.5 text-xs font-semibold bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200 rounded-lg transition-colors"
              >
                ...
                return (
                  <div key={r.id} className="bg-white rounded-xl p-3.5 border border-slate-200 shadow-2xs space-y-2.5">
                    ...
                    <div className="flex items-center justify-end space-x-2 pt-1 border-t border-slate-100">
                      <button
                        onClick={() => onEdit(r)}
                        className="inline-flex items-center space-x-1 px-3 py-1.5 rounded-lg text-xs font-semibold text-blue-700 bg-blue-50 hover:bg-blue-100 active:scale-95 transition-all"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center space-x-1 px-3 py-1.5 rounded-lg text-xs font-semibold text-red-600 bg-red-50 hover:bg-red-100 active:scale-95 transition-all"
                      >
