    ...
    <div className="space-y-6 animate-in fade-in duration-150">
      ...
      <div className="bg-white p-3.5 sm:p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 w-full md:w-auto">
          ...
          <button
            onClick={onAddNew}
            className="inline-flex items-center justify-center space-x-1.5 px-3.5 py-2 sm:py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-bold transition-all shadow-sm shadow-blue-200 active:scale-95 shrink-0 w-full sm:w-auto"
          >
